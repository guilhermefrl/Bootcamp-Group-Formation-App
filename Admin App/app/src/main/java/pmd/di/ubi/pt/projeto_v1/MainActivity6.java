...
public class MainActivity6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Query orderByChild= mFirebaseRef.child("Eventos").orderByChild("fechado").equalTo(1);

        myListView =findViewById(R.id.mostrar_eventos_equipas);
        ...
        myListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent it = new Intent(MainActivity6.this, MainActivity7.class);
    ...
    public void GoHome(View view){
        startActivity(new Intent(MainActivity6.this, Activity_admin_pagina_escolha.class));
    }
}